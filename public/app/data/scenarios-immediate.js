...
export const immediateScenarios = [
    {
        ...
        dangerAssessment: 'You may be in a life-threatening situation right now. Protecting life comes before every other consideration. Contact emergency services as soon as it is safe to do so.',
        phases: [
            {
                label: 'DO THIS NOW',
                now: true,
