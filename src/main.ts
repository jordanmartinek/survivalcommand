...
import {
  resourcesView, waterCenterView, foodView, powerView, inventoryView,
...
import {
  improviseView, improviseDetailView, canIUseView, usableDetailView, nothingView,
} from './views/improvise.js';
...
// ---- Tab bar ------------------------------------------------------------
interface Tab { path: string; icon: string; label: string; match: (p: string) => boolean; }
const TABS: Tab[] = [
