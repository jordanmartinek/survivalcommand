...
export const naturalScenarios: Scenario[] = [
  {
    id: 'earthquake',
    title: 'Earthquake',
    icon: '🌐',
    ...
    dangerAssessment:
      'During shaking, most injuries come from falling objects and collapsing structures. Protect yourself first, then assess damage and expect aftershocks.',
    phases: [
      {
  ...
  },
  {
    ...
    dangerAssessment:
      'Moving water is deceptively powerful and often contaminated. A small depth can knock you down or float a vehicle. Move to higher ground early — do not wait.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
  ...
  },
  {
    ...
    dangerAssessment:
      'Wildfires move fast and unpredictably. If evacuation is ordered or advised, leaving early is far safer than leaving late. Smoke is also a serious health hazard.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
  ...
  },
  {
    ...
    dangerAssessment:
      'Extreme heat can cause heat exhaustion and life-threatening heat stroke, particularly in the elderly, young children, and those without cooling. Heat overrides food as a priority.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
  ...
  },
  {
    ...
    dangerAssessment:
      'Cold causes hypothermia and frostbite, and improvised heating causes carbon-monoxide poisoning and fires. Stay dry, insulated, and heat safely.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
  ...
  },
  {
    ...
    dangerAssessment:
      'Severe storms combine wind, flooding, and power loss, and the aftermath can be as dangerous as the storm. Follow evacuation orders and prepare to be self-sufficient afterward.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
