...
export const infrastructureScenarios: Scenario[] = [
  {
    id: 'grid-failure',
    ...
    dangerAssessment:
      'A power outage is rarely an immediate threat by itself, but it can quickly endanger water, heating/cooling, medical equipment, and communication. Treat an outage of unknown duration as potentially extended.',
    phases: [
      {
        ...
        options: [
          {
            label: 'Understood',
            result:
              'Run normal conservation: keep fridge closed, preserve phone battery, set up light. Recheck in 1 hour.',
          },
        ],
      },
      {
  ...
  },
  {
    ...
    dangerAssessment:
      'Safe drinking water is a top survival priority. Without it, dehydration becomes dangerous within days — faster in heat or with exertion. Do not wait to act.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
  ...
  },
  {
    ...
    dangerAssessment:
      'A communications outage is mainly dangerous because it delays emergency help and official information. Conserve device power and fall back to pre-arranged plans.',
    phases: [
      {
        label: 'DO THIS NOW',
        now: true,
